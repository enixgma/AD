...
$user_name = $_SESSION['user_name']; // Fetch the user's name from session
...
<head>
    ...
    <link rel="stylesheet" href="css/traveler_style.css">
...
<body>
    ...
    <button class="dropbtn">
        ...
        <div class="profile-picture">
            <img src="img/esny2.jpg" alt="DP">
        </div>
        <?php echo htmlspecialchars($user_name); ?> <i class="fa fa-caret-down"></i>
    </button>
    <div class="dropdown-content">
        ...
        <a href="index.php">Log Out</a> <!-- Changed logout link to a separate page -->
    </div>
</div>
